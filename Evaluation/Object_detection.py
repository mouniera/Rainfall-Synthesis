...
class AutoVivification(dict):
    """Implementation of autovivification."""
...
def compute_attributs(date:str,run:str,list_MB:list[str],zone_l:list[str],lead_times:list[int],cumul_RR: int,type_AE_EPS: str,name_config=None):
    ...
    path_attributs=path_out+"Attributs_RR"+str(cumul_RR)+"h_"+date+"_R"+run+"_begin_"+str(lead_times[0])+"_end_"+str(lead_times[-1])+".pkl"
